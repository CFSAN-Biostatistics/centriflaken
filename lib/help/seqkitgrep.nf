    ...
    toolspecs = [
        'seqkit_grep_n': [
            clihelp: 'Match by full name instead of just ID. ' +
                "Defaut: " + (params.seqkit_grep_n ?: 'undefined'),
        ...
        'seqkit_grep_m': [
            clihelp: 'Maximum mismatches when matching by sequence. ' +
                "Defaut: " + (params.seqkit_grep_m ?: 'undefined'),

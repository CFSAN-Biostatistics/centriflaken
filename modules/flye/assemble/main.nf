process FLYE_ASSEMBLE {
    ...
    module (params.enable_module ? "${params.swmodulepath}${params.fs}flye${params.fs}2.9" : null)
    conda (params.enable_conda ? "bioconda::flye=2.9.0" : null)
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/flye:2.9--py38hf4f3596_1' :
        'quay.io/biocontainers/flye:2.9--py38hf4f3596_1' }"
